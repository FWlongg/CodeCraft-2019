写在前头，求登录给个star，判题器大佬走开，让我先凑几个星星，跑官方给的测试小地图1的话十来秒吧（不是训练赛的地图1！！！）
...
6. map存放了官方给的两个测试地图，有官方给出的正确结果，因为基本有效成绩也就是系统调度时间，所以我跳过了其他次要条件
...
8. 对了运行的时候记得F11全屏，并“ctrl”+“-” 多缩小几次字体，还是挺好玩的（就显示了道路车辆占比和数量）(注，之后字体调回去可是“ctrl”+“shift”+“+”哟，队友也被搞过，但你们知道为什么要加一个shift嘛，知道答案的我，哈哈哈，笑死我了)
